 ...
 *
 * 가스(SOL)는 위임 자금이 아니라 실행 비용이라 서버가 대납한다(`fundAgentGas`).
 */
import {
...
/** 에이전트 지갑이 온체인 실행에 쓸 가스. 위임 한도와 무관한 운영 비용이다. */
export const AGENT_GAS_SOL = Number(process.env.AGENT_GAS_SOL || 0.05);
